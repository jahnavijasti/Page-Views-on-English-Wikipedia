...
## Reading 'pageviews_mobile-web_201507-201709.csv' and specify the dates  
...
## Reading 'pageviews_mobile-app_201507-201709.csv' and specify the dates  
...
## Reading 'pageviews_desktop_201507-201709.csv' and specify the dates  
...
## Reading 'pagecounts_mobile_200801-201607.csv' and specify the dates  
...
## Reading 'pagecounts_desktop_200801-201607.csv' and specify the dates  
...
## Merging pageviews data for both desktop and miobile site
...
## Merging pagecounts data for both desktop and miobile site
...
## Merging pageviews and pagecounts for both mobile and desktop views into a single dataframe
...
legend("topleft",legend=c('pagecount_desktop_views', 'pagecount_mobile_views',
       ...
       lty=2,col=c("red","red","brown", "blue", "blue", "black" ),lwd=2, bg = 'white', 
